...
neutral_filename = "GB_v54.1_capture_only_100k"
perm_path = Path(f"{EM_dir}/{neutral_filename}_permuted_EM.pkl")
with open(perm_path, "rb") as file:
    nf = pickle.load(file)

gengamma_save_path = Path(f"{output_dir}/{neutral_filename}_gengamma_perm_fit.pkl")
