...
AADR_VERSION = "v54.1"
EXTRACTED_PREFIX = f"extracted/UK_{AADR_VERSION}"
# all of them
...
def plotPCA (theTitle, pcs, evals, categories, pca_plot_file, selectMask=None, plotCentroid=False):
    ...
    for (catMask, catName, catMarker, catColor) in categories:
                ...
                for pop in sorted(set(popLabels)):
                    ...
                    if (pop in ["FOCAL_ANCIENT_SG", "FOCAL_ANCIENT_CAPTURE"]):
                        ...
                        for pub in set(short_pubs):
                            ...
                            categories.append ((thisPopMask & thisPubMask, short_pop + "_" + pub, getDefaultMarker (colorIdx), getDefaultColor (colorIdx)))
                            colorIdx += 1
                    else:
                        # regular
