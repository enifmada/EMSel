This directory contains scripts to extract the subset of the individuals in the UK from the AADR used for the analysis detailed in the manuscript. This subset comprises all individuals with:
...
Exectuing:
```
python step1_subset_uk_anno.py
```
...
```
extracted/UK_v54.1_capture_only_broad_pca_noshrinkage.pdf
extracted/UK_v54.1_capture_only_broad_pca_shrinkage.pdf
extracted/UK_v54.1_capture_only_europe_pca_noshrinkage.pdf
extracted/UK_v54.1_capture_only_europe_pca_shrinkage.pdf
extracted/UK_v54.1_capture_only_gbr_ceu_pca_noshrinkage.pdf
extracted/UK_v54.1_capture_only_gbr_ceu_pca_shrinkage.pdf
extracted/UK_v54.1_capture_SG_broad_pca_noshrinkage.pdf
extracted/UK_v54.1_capture_SG_broad_pca_shrinkage.pdf
extracted/UK_v54.1_capture_SG_europe_pca_noshrinkage.pdf
extracted/UK_v54.1_capture_SG_europe_pca_shrinkage.pdf
extracted/UK_v54.1_capture_SG_gbr_ceu_pca_noshrinkage.pdf
extracted/UK_v54.1_capture_SG_gbr_ceu_pca_shrinkage.pdf
```
...
produces the plots
```
extracted/UK_v54.1_capture_only_map.pdf
extracted/UK_v54.1_capture_SG_map.pdf
```
...
produces the plots
```
extracted/UK_v54.1_capture_only_sample_sizes.pdf
extracted/UK_v54.1_capture_SG_sample_sizes.pdf
```
...
```
extracted/UK_v54.1_capture_SG_inds.table
```
...
```
extracted/UK_v54.1_capture_SG_c*.vcf
```
