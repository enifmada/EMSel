...
## Figure S.14:
First, run `emsel-sim data/ibdne/big -s .005 --sel_types neutral --seed 2653305 -n 10000 --data_matched data/GB_v54.1_capture_only_means.txt data/GB_v54.1_capture_only_missingness.txt data/GB_v54.1_capture_only_sample_sizes.table --vary_Ne data/ibdne_raw.txt --suffix fit --save_plots` and `emsel-sim data/ibdne/big -s .005 --sel_types neutral --seed 90014521 -n 100000 --data_matched data/GB_v54.1_capture_only_means.txt data/GB_v54.1_capture_only_missingness.txt data/GB_v54.1_capture_only_sample_sizes.table --vary_Ne data/ibdne_raw.txt --suffix plot --save_plots` to generate the 10k fitting replicates and 100k plotting replicates, matched to the IBDNe dataset, for this figure. 
