...
## Figure S.14:
First, Run `emsel-sim data/ibdne/big -s .005 --sel_types neutral --seed 100000 -n 50000 --data_matched data/GB_v54.1_capture_only_means.txt data/GB_v54.1_capture_only_missingness.txt data/GB_v54.1_capture_only_sample_sizes.table --vary_Ne data/ibdne_raw.txt --suffix big_0 --save_plots` and `emsel-sim data/ibdne/big -s .005 --sel_types neutral --seed 100001 -n 50000 --data_matched data/GB_v54.1_capture_only_means.txt data/GB_v54.1_capture_only_missingness.txt data/GB_v54.1_capture_only_sample_sizes.table --vary_Ne data/ibdne_raw.txt --suffix big_1 --save_plots` to generate the 100k replicate IBDNe dataset for this figure. 
